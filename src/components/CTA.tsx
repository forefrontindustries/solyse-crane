...
export function CTA() {
  ...
  return (
    <section id="contact" ref={sectionRef} className="py-24 md:py-32 bg-primary text-primary-foreground relative overflow-hidden">
      {/* Grid pattern */}
      ...
      <div className="max-w-[1600px] mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className={cn("inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-8 transition-all duration-500", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4")}>
            ...
            <span className="text-white/90 text-sm font-medium">Let's talk logistics</span>
          </div>
          ...
          {/* Primary CTA Button + Link below */}
          <div className={cn("flex flex-col items-center gap-4 mb-16 transition-all duration-500 delay-300", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4")}>
            <a href="#" className="inline-flex items-center justify-center gap-2 bg-secondary hover:bg-secondary/90 text-secondary-foreground font-semibold px-10 h-14 text-base rounded-lg transition-colors group shadow-lg shadow-secondary/20">
              Get a Free Quote
            ...
            <a href="#" className="text-sm text-white/60 hover:text-white/90 transition-colors underline underline-offset-4 decoration-white/30 hover:decoration-white/60">
              Or schedule a consultation with our team
            </a>
          </div>

          {/* Contact options */}
          <div className={cn("grid sm:grid-cols-2 gap-6 pt-12 border-t border-white/10 max-w-lg mx-auto transition-all duration-500 delay-[400ms]", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4")}>
